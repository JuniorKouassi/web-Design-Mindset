...
export default function HeroSection() {
  return (
    ...
    >
      ...
      {/* Subtle radial glow — navy palette */}
      <div
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 pt-24 pb-12 sm:px-6 md:pt-32 md:pb-20 lg:px-8">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center space-y-8 pt-8">
              ...
              >
                ...
                >
                  ...
                  <Star
                    ...
                    style={{ color: "#6b8ec4", fill: "#6b8ec4" }}
                  />
                </span>
              </div>
            </div>
            ...
            {/* Description */}
            <p
              className="animate-fade-in delay-300 max-w-xl text-lg leading-relaxed"
          ...
          <div className="lg:col-span-5 space-y-6 lg:mt-12">
            ...
            {/* Stats Card */}
            <div
              className="animate-fade-in delay-500 relative overflow-hidden rounded-3xl p-8 backdrop-blur-xl shadow-2xl"
              style={{
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-3 mb-8">
                  <div className="flex justify-between text-sm">
                    <span style={{ color: "rgba(168,192,224,0.70)" }}>Client Satisfaction</span>
                  ...
                  >
                    <div
                      ...
                      style={{
                        background: "linear-gradient(to right, #6b8ec4, #a8c0e0)",
                      }}
                    />
                  </div>
                </div>
